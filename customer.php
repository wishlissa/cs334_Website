...
//insert data into database
	$sql = "INSERT INTO skiShopCustomers(lastName, firstName, streetAddress1, streetAddress2, city, state, postalCode, email, userID, password) 
		VALUES('$lastName', '$firstName', '$streetAddress1', '$streetAddress2', '$city', '$state', '$postalCode', '$email', '$userID', '$password')";
