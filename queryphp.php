...
//Get form values
	$brand = $_POST['brand'];
	$color = $_POST['color'];
	$_SESSION['brandShare'] = $brand;
	$_SESSION['colorShare'] = $color;
...
//print query results
	...
	while ($row = mysqli_fetch_array($result)) {
		...
		$count++;
			...
			echo "To view your full results, click <a href='http://mrp82.x10host.com/labs/Final/fullresults.php'>here</a>.";
			break;
		}
	}
